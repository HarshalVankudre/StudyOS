...
export const ar = {
  ...
  meta: {
    ...
    pricingDescription:
      "قارن بين StudyOS المجاني وPro. ابدأ مجانًا وارقَ عندما تريد النموذج الأقوى، ومخصصًا شهريًا أكبر من الأرصدة، ودعمًا ذا أولوية.",
  ...
  landing: {
    ...
    features: {
      ...
      items: {
        ...
        flashcards: {
          k: "بطاقات تعليمية",
          title: "ادرس بالتكرار المتباعد",
          body: "حوّل أي موضوع إلى مجموعة بطاقات. يجدول StudyOS كل بطاقة لتراجعها قبيل أن تنساها.",
        },
        calendar: {
          k: "مزامنة التقويم",
          title: "مواعيدك النهائية، في كل مكان",
          body: "اشترك في تقويم Google أو Apple أو Outlook — يبقى كل واجب واختبار متزامنًا تلقائيًا.",
        },
        syllabus: {
          k: "استيراد المنهج الدراسي",
          title: "ابدأ من منهجك الدراسي",
          body: "الصق منهجك الدراسي أو ارفعه، ويبني StudyOS انطلاقًا من موادك وتواريخك وموضوعاتك الحقيقية.",
        },
        databases: {
          k: "قواعد بيانات",
    ...
    pricing: {
      ...
      free: {
        ...
        features: [
          ...
          "بطاقات تعليمية وتكرار متباعد",
          "مزامنة التقويم واستيراد المنهج الدراسي",
  ...
  pricing: {
    ...
    subtitle:
      "كل ما تحتاجه لتنظيم فصلك الدراسي مجاني. وتضيف خطة Pro النموذج الأقوى، ومخصصًا شهريًا أكبر من الأرصدة، ودعمًا ذا أولوية.",
    free: {
      name: "مجاني",
      price: "$0",
      ...
      bulletCredits: "{count} رصيد ذكاء اصطناعي مجاني كل شهر",
    },
    pro: {
      badge: "الأكثر رواجًا",
      name: "Pro",
      ...
      bulletCredits: "{count} رصيد ذكاء اصطناعي كل شهر",
    },
    comparison: {
      title: "قارن الخطط",
      ...
      features: {
        ...
        calendarSync: "مزامنة التقويم (Google / Apple / Outlook)",
        syllabusImport: "استيراد المنهج الدراسي",
    ...
    credits: {
      ...
      freeIncludes: "تشمل الخطة المجانية {count} رصيدًا كل شهر",
      proIncludes: "تشمل Pro {count} رصيدًا كل شهر",
      neverExpire: "أعِد الشحن في أي وقت — الحزم المشتراة لا تنتهي صلاحيتها",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "مخصص شهري كبير من الأرصدة، والنموذج الأقوى لمساحات عمل أغنى وأدقّ، ودعم ذو أولوية، ووصول مبكر إلى المزايا الجديدة.",
      },
      {
  ...
  generate: {
    ...
    syllabus: {
      toggle: "📄 أضف منهجك الدراسي",
      optional: "اختياري",
      hint: "الصق منهجك الدراسي أو قائمة موادك، أو ارفع ملف .txt، وسيبني StudyOS انطلاقًا من موادك ومواعيدك النهائية وموضوعاتك الحقيقية.",
      placeholder:
        "الصق هنا منهجك الدراسي أو قائمة موادك أو جدول الفصل الدراسي…",
      upload: "رفع ملف .txt",
      attached: "تمت إضافة {chars} حرف",
      clear: "مسح",
    },
    questions: {
      back: "← تعديل الوصف",
  ...
  credits: {
    ...
    low: "منخفض",
    runningLow: "أرصدتك على وشك النفاد.",
    turnCostTitle: "أرصدة هذه الجولة",
    buysApprox: "≈ {gens} من إنشاءات مساحات العمل أو {edits} من تعديلات الوكيل",
    buyMore: "شراء المزيد",
  },
  ...
  settings: {
    ...
    creditsDesc:
      "تشغّل الأرصدة كل طلب ذكاء اصطناعي. تجدّد خطتك الأرصدة شهريًا، والحزم المشتراة لا تنتهي صلاحيتها.",
    ...
    deleteAccountDesc:
      "احذف حسابك ومساحات عملك وأرصدتك واشتراكك نهائيًا. لا يمكن التراجع عن ذلك.",
    deleteAccountConfirm:
      "هل تريد حذف حسابك نهائيًا؟\n\nستُزال كل مساحات العمل والأرصدة واشتراكك. لا يمكن التراجع عن ذلك.",
    deleteAccountButton: "حذف حسابي",
    deleting: "جارٍ الحذف…",
    deleteAccountError:
      "تعذّر علينا إلغاء اشتراكك في الوقت الحالي، لذا لم يُحذف أي شيء. يُرجى المحاولة مرة أخرى بعد قليل.",
  },
  ...
  errors: {
    ...
    notFoundBody: "هذه الصفحة غير موجودة — ربما نُقلت أو حُذفت.",
    errorTitle: "حدث خطأ ما",
    errorBody:
      "حدث خطأ غير متوقع. عملك محفوظ تلقائيًا — حاول مرة أخرى.",
  ...
  calendar: {
    ...
    description:
      "اشترك في مواعيدك النهائية على تقويم Google أو Apple أو Outlook. تبقى واجباتك واختباراتك والعناصر المؤرَّخة محدَّثة تلقائيًا.",
    urlLabel: "رابط التقويم الخاص بك",
    copy: "نسخ",
    copied: "تم النسخ ✓",
    ...
    instructions:
      "الصق هذا الرابط في خيار «الاشتراك من عنوان URL» في تطبيق التقويم لديك. احتفظ به خاصًا — يمكن لأي شخص لديه الرابط رؤية مواعيدك النهائية. أعد تعيينه في أي وقت لإلغاء الوصول.",
  },

  // ---- Usage limits --------------------------------------------------------
  limits: {
    rateLimited:
      "وصلت إلى حد الطلبات حاليًا. يُرجى الانتظار قليلًا ثم المحاولة مرة أخرى.",
    sandboxQuota: "وصلت إلى حد التصيير لهذا اليوم. يُعاد ضبطه غدًا.",
  },
